...
create table admin_action (
    ...
    action_kind varchar(50) not null,                   -- 'verify_business', 'approve_listing', 'rebuild_listing_projection'
...
create table system_alert (
    ...
    source varchar(50) not null,                        -- 'listing.projection_refresh', 'circuit_breaker.law_api'

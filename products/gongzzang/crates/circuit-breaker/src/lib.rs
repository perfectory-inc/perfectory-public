...
//!
//! 사용 예 (Foundation Platform published API):
//! ```ignore
//! use circuit_breaker::{execute, Breaker, Policy};
//!
//! let breaker = Breaker::new();
//! let policy = Policy::foundation_platform_default();
//! let result = execute(&breaker, &policy, "foundation_platform.catalog", || async {

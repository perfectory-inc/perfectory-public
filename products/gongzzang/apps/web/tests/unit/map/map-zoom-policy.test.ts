...
describe("Gongzzang map zoom policy", () => {
  it("keeps product-owned listing marker visibility at parcel zoom while foundation-platform anchors can start earlier", () => {
    expect(GONGZZANG_MAP_ZOOM_POLICY.foundationPlatform.exactParcelAnchorMinZoom).toBe(12);

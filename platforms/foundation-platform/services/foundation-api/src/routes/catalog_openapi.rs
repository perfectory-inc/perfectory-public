...
use foundation_contracts::catalog::{
    ...
    MarkerTileContractResponse, ParcelCharacteristicResponse, ParcelIndustryAssignmentResponse,
...
#[openapi(
    ...
    paths(
        ...
        super::catalog::get_building,
        super::catalog::get_building_by_register_pk,
        super::catalog::list_building_units,

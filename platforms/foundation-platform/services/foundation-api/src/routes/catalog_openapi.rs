...
use foundation_contracts::catalog::{
    ...
    IndustrialComplexGoldPointerResponse, IndustrialComplexListResponse, IndustrialComplexResponse,
    IndustryGroupMemberResponse, IndustryGroupResponse, ManufacturerResponse,
    ...
    UnitOfficialPriceResponse, UnitPageResponse, UnitResponse, UpdateComplexRequest,
...
#[openapi(
    ...
    paths(
        ...
        super::catalog::complex_search::list_complexes,
        super::catalog::building_units::list_parcel_buildings_by_pnu,
        super::catalog::building_units::list_parcel_units_by_pnu,
    ...
    components(schemas(
        ...
        ParcelCharacteristicResponse,
        ParcelForestLedgerResponse,
        ParcelLandRightResponse,
        ParcelTransferEventResponse,
        ParcelResponse,
        ParcelZoningResponse,
        ParcelPriceResponse,

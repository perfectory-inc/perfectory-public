...
mod tests {
    ...
    #[test]
    fn try_new_wgs84_repository_synthetic_bbox() {
        let bbox = BoundingBox::try_new_wgs84(
            127.123_470_234_30,
            36.123_440,
            127.123_470_234_80,
            36.123_470,
        ...
        .expect("valid");
        assert!((bbox.min_lng - 127.123_470_234_30).abs() < f64::EPSILON);
        assert!((bbox.max_lat - 36.123_470).abs() < f64::EPSILON);
    }

    #[test]
    fn rejects_min_lng_ge_max_lng() {
        let err = BoundingBox::try_new_wgs84(
            127.123_470_234_80,
            36.123_440,
            127.123_470_234_30,
            36.123_470,
    ...
    fn rejects_min_eq_max_lng() {
        let err = BoundingBox::try_new_wgs84(127.123_460, 36.123_440, 127.123_460, 36.123_470)
            .unwrap_err();
        assert!(matches!(err, BoundingBoxError::InvalidOrder { .. }));
    }
    ...
    fn rejects_lng_out_of_range() {
        let err = BoundingBox::try_new_wgs84(-181.0, 36.123_440, 127.123_470_234_80, 36.123_470)
            .unwrap_err();
    ...
    fn rejects_lat_out_of_range() {
        let err =
            BoundingBox::try_new_wgs84(127.123_470_234_30, 36.123_440, 127.123_470_234_80, 91.0)
                .unwrap_err();
    ...
    #[test]
    fn rejects_nan() {
        let err = BoundingBox::try_new_wgs84(f64::NAN, 36.123_440, 127.123_470_234_80, 36.123_470)
            .unwrap_err();
    ...
    fn rejects_infinity() {
        let err =
            BoundingBox::try_new_wgs84(127.123_470_234_30, 36.123_440, f64::INFINITY, 36.123_470)
                .unwrap_err();
        assert!(matches!(err, BoundingBoxError::NotFinite { .. }));
    }
    ...
    fn contains_point_inside() {
        ...
        .expect("valid");
        let point = PointSrid::try_new_wgs84(127.123_470_234_50, 36.123_450).expect("valid");
    ...
    fn contains_point_on_boundary() {
        ...
        .expect("valid");
        let point = PointSrid::try_new_wgs84(127.123_470_234_30, 36.123_440).expect("valid");
        assert!(bbox.contains(&point));
    }
    ...
    fn contains_point_outside() {
        ...
        .expect("valid");
        let point = PointSrid::try_new_wgs84(127.123_500, 36.123_450).expect("valid");
        assert!(!bbox.contains(&point));
    }

...
reset_tmp_root
write_lines "${tmp_root}/docs/archive/plans/oversized.md" 1501
assert_failure_contains "scans archived plan files" "oversized.md has 1501 lines" bash "$script" "$tmp_root"

reset_tmp_root
write_lines "${tmp_root}/docs/archive/plans/at-limit.md" 1500

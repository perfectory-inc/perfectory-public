...
| [0025](./0025-bronze-scraping-workflow-orchestrator-not-rust-spawn.md) | Bronze producer isolation; historical Gongzzang orchestration moved to Foundation Platform | Superseded operationally by 0034/0048 |
...
| [0027](./0027-admin-complex-layer-source-deferred.md) | Static layers must use source-specific data; availability comes from the Foundation manifest | Superseded operationally by 0034/0036/0048 |
...
| [0040](./0040-bazel-first-build-verification-control-plane.md) | Bazel-first build and verification control plane | Superseded by 0044 |
| [0041](./0041-hermetic-javascript-package-bazel-rules.md) | Hermetic JavaScript package Bazel rules | Superseded by 0044 |
| [0042](./0042-cross-repo-bazel-native-build-graph.md) | Cross-area Bazel-native build graph | Superseded by 0044 |
| [0043](./0043-bazel-transition-provisioning-decisions.md) | Bazel transition provisioning decisions | Superseded by 0044 |
| [0044](./0044-bazel-transition-reconciliation.md) | Native build and verification SSOT | Accepted |
| [0045](./0045-adr-placement-cross-repo-governance.md) | ADR placement and cross-area governance | Superseded by root ADR-0001 |
| [0046](./0046-kafka-kubernetes-preliminary-design.md) | Kafka & Kubernetes Preliminary Design — trigger 전까지 보류 | Accepted (deferred) |
| [0047](./0047-collection-event-fabric.md) | Collection Event Fabric — broker 없이 유지하는 Bronze-ingestion control plane | Accepted (broker deferred) |
| [0048](./0048-horizontal-platform-redefinition.md) | Horizontal Platform Redefinition | Accepted |
| [0049](./0049-identity-platform-contract-design.md) | Identity Platform Contract Design | Accepted |
| [0050](./0050-dawneer-workbench-and-internal-admin-surface.md) | Dawneer Workbench and Internal Admin Surface | Accepted |

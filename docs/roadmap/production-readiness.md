...
2026-08-05에 **여덟 ADR을 모두 실물과 대조했다.** 기록된 37항목 중 열린 것은 **21개**다. 나머지
16개는 이미 닫혔거나(6), 애초에 부채가 아니거나(정정·감사 결과·교훈 기록 3), 지켜야 할 코드가 아직
없어 도달할 수 없거나(4), 의도적 결정이다(3). 닫힌 6개 중 **셋은 아무도 ADR에 적지 않은 채로**
닫혀 있었고(그중 하나는 자기를 인용한 CI 주석까지 달려 있었다), 셋은 이 대조를 하면서 닫았다.
...
| [0012 검증 결과의 의미](../adr/0012-verification-results-must-mean-what-they-say.md) | 3 | 1 | xtask 전수 모드 부재 | 4 |

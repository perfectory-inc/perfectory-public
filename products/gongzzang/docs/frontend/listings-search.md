...
Map marker placement is not owned by listing cards. The map consumes the foundation-platform
...
copy foundation-platform PNU anchor positions with source lineage.
...
- Marker locations: foundation-platform parcel marker anchors, served as PBF vector tiles.
- Parcel identity: PNU.

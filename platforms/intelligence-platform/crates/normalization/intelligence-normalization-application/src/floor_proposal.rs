...
pub struct BuildingRegisterFloorInputErrorSummary {
    pub line: usize,
    pub message: String,
}

#[derive(Clone, Debug, Default, Eq, PartialEq, Serialize)]
pub struct BuildingRegisterFloorProposalJobSummary {
    pub input_row_count: usize,
    pub request_count: usize,
    pub submitted_count: usize,
    pub skipped_invalid_count: usize,
    pub invalid_input_count: usize,
    pub input_errors: Vec<BuildingRegisterFloorInputErrorSummary>,
}

#[derive(Clone, Debug, Default, PartialEq, Serialize)]
pub struct BuildingRegisterFloorProposalDryRunSummary {
    pub input_row_count: usize,
    pub request_count: usize,
    pub invalid_input_count: usize,
...
pub async fn run_floor_proposal<G, S>(
...
{
    let mut summary = BuildingRegisterFloorProposalJobSummary {
        input_row_count,
...
pub async fn run_floor_proposal_dry_run<G>(
    input_row_count: usize,
    requests: Vec<NormalizationRequest>,
    input_errors: Vec<BuildingRegisterFloorInputErrorSummary>,
    minimum_confidence: f64,
...
where
    G: NormalizationProposalGenerator + ?Sized,
{
    let mut summary = BuildingRegisterFloorProposalDryRunSummary {
        input_row_count,
        request_count: requests.len(),
        invalid_input_count: input_errors.len(),
        input_errors,

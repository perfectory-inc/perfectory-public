...
SP4-ii 에서 V-World ACL(`crates/data-clients/vworld/`; historical — Foundation Platform-owned after ADR 0034)
...
- raw 응답 캡처 fixture: `crates/data-clients/vworld/tests/fixtures/` (historical; Foundation Platform-owned after ADR 0034)
- 검증 패턴 baseline: `crates/data-clients/data-go-kr/tests/real_response_fixtures.rs` (historical; Foundation Platform-owned after ADR 0034)
> Current status (2026-05-28): Historical. V-World Catalog ingestion is now
> owned by Foundation Platform under ADR 0034. Do not recreate the local Gongzzang
> V-World client paths described below; Gongzzang consumes Foundation Platform

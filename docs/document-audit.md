...
- 감사 문서: **359개**
- 언어 분류: **{'english': 34, 'korean': 164, 'mixed': 161}**
- 한글화 대상 유지 문서: **영문 전용 0개 / 혼합 표기 85개** (기계 계약·라우터·법률 예외 제외)
- 유지 문서의 명백한 영문 문장: **0개**
- 메타데이터: **200개 정상 / 0개 누락 / 159개 해당 없음**
- 중복 파일명 후보: **0개**
- 링크·참조 위반: **0개**
- 승인 전 문서 유입 링크 0건: **0개**
...
| `docs/adr/0006-object-storage-first-serving.md` | Monorepo | ADR | current | mixed | not applicable: ADR fields | 9 |
...
| `docs/adr/0012-verification-results-must-mean-what-they-say.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 7 |
...
| `docs/adr/0016-a-postgis-projection-load-is-a-fact-with-an-identity.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 15 |
...
| `docs/adr/0019-membership-is-a-dated-fact-not-a-column.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 19 |
| `docs/adr/0020-geometry-is-not-evidence-for-a-fact.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 14 |
| `docs/adr/0021-an-unread-surface-is-deleted-not-migrated.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 10 |
...
| `docs/adr/0025-parcel-publication-names-one-sealed-iceberg-evidence.md` | Monorepo | ADR | current | mixed | not applicable: ADR fields | 6 |
| `docs/adr/0026-parcel-evidence-sealer-is-the-only-append-boundary.md` | Monorepo | ADR | current | mixed | not applicable: ADR fields | 3 |
| `docs/adr/0027-every-guard-declares-its-threat-model.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 11 |
...
| `docs/adr/0029-parcel-publication-evidence-is-written-from-the-terminal-run.md` | Monorepo | ADR | current | mixed | not applicable: ADR fields | 3 |
| `docs/adr/0030-parcel-publication-evidence-requires-two-distinct-approvals.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 1 |
...
| `docs/adr/0033-an-industrial-complex-without-a-sourced-address-is-not-representable.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 6 |
| `docs/adr/0034-an-administrative-code-carries-its-own-granularity.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 4 |
...
| `platforms/foundation-platform/crates/foundation-contracts/README.md` | Foundation Platform | README | current | korean | ok | 0 |
...
| `platforms/foundation-platform/docs/adr/0004-static-vector-tile-runtime-contract.md` | Foundation Platform | ADR | current | mixed | not applicable: ADR fields | 14 |
...
| `platforms/foundation-platform/docs/db/catalog-schema-contract.v1.example.json` | Foundation Platform | fixture | fixture | english | not applicable: machine contract | 0 |
| `platforms/foundation-platform/docs/events/event-fabric-registry.v1.example.json` | Foundation Platform | fixture | fixture | english | not applicable: machine contract | 0 |
| `platforms/foundation-platform/docs/events/lineage/lakehouse-lineage-event.v1.example.json` | Foundation Platform | fixture | fixture | english | not applicable: machine contract | 1 |
| `platforms/foundation-platform/docs/events/webhook/outbox-webhook-envelope.v1.example.json` | Foundation Platform | fixture | fixture | english | not applicable: machine contract | 0 |
| `platforms/foundation-platform/docs/events/webhook/parcel-marker-anchor-snapshot-envelope.v1.example.json` | Foundation Platform | fixture | fixture | english | not applicable: machine contract | 0 |
...
| `platforms/foundation-platform/docs/runbooks/r2-lakehouse-live-verification.md` | Foundation Platform | runbook | current | korean | ok | 1 |
...
| `platforms/identity-platform/crates/identity-contracts/README.md` | Identity Platform | README | current | korean | ok | 0 |
| `platforms/identity-platform/crates/identity-shared-kernel/README.md` | Identity Platform | README | current | korean | ok | 0 |
| `platforms/identity-platform/crates/service-identity/README.md` | Identity Platform | README | current | mixed | ok | 0 |
| `platforms/identity-platform/crates/staff-identity/README.md` | Identity Platform | README | current | korean | ok | 0 |
| `platforms/identity-platform/docs/adr/0001-inherit-monorepo-conventions.md` | Identity Platform | ADR | Accepted | korean | not applicable: ADR fields | 2 |
...
| `products/gongzzang/crates/api-types/README.md` | Gongzzang 제품 | README | current | mixed | ok | 0 |
| `products/gongzzang/crates/audit-log-domain/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/bookmark-domain/README.md` | Gongzzang 제품 | README | current | mixed | ok | 0 |
...
| `products/gongzzang/crates/gongzzang-outbox/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/gongzzang-persistence/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/listing-domain/README.md` | Gongzzang 제품 | README | current | mixed | ok | 0 |
| `products/gongzzang/crates/listing-photo-domain/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/listing-report-domain/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/listing-review-domain/README.md` | Gongzzang 제품 | README | current | mixed | ok | 0 |
| `products/gongzzang/crates/notification-domain/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/outbox-event-domain/README.md` | Gongzzang 제품 | README | current | mixed | ok | 0 |
| `products/gongzzang/crates/parcel-lookup/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/product-identity-infrastructure/README.md` | Gongzzang 제품 | README | current | mixed | ok | 0 |
| `products/gongzzang/crates/real-transaction-domain/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/repo-guard/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
| `products/gongzzang/crates/search-history-domain/README.md` | Gongzzang 제품 | README | current | mixed | ok | 0 |
...
| `products/gongzzang/docs/adr/0013-listing-search-naver-maps.md` | Gongzzang 제품 | ADR | current | korean | not applicable: ADR fields | 2 |
| `products/gongzzang/docs/adr/0014-base-layer-defer-pmtiles.md` | Gongzzang 제품 | ADR | current | korean | not applicable: ADR fields | 3 |
...
| `products/gongzzang/docs/architecture/platform-integration/lakehouse-registry-policy.v1.json` | Gongzzang 제품 | architecture | current | english | not applicable: machine contract | 1 |
| `products/gongzzang/docs/architecture/platform-integration/operations-policy.v1.json` | Gongzzang 제품 | architecture | current | english | not applicable: machine contract | 0 |
| `products/gongzzang/docs/architecture/platform-integration/route-exposure-policy.v1.json` | Gongzzang 제품 | architecture | current | english | not applicable: machine contract | 0 |
| `products/gongzzang/docs/architecture/platform-integration/service-auth-policy.v1.json` | Gongzzang 제품 | architecture | current | english | not applicable: machine contract | 0 |
| `products/gongzzang/docs/architecture/platform-integration/supply-chain-policy.v1.json` | Gongzzang 제품 | architecture | current | english | not applicable: machine contract | 1 |
| `products/gongzzang/docs/architecture/platform-integration/webhook-policy.v1.json` | Gongzzang 제품 | architecture | current | english | not applicable: machine contract | 0 |
| `products/gongzzang/docs/architecture/README.md` | Gongzzang 제품 | README | current | mixed | ok | 1 |
| `products/gongzzang/docs/architecture/traffic-auth-policy-registry.v1.json` | Gongzzang 제품 | architecture | current | english | not applicable: machine contract | 0 |
...
| `products/gongzzang/docs/conventions/enforcement-flow.md` | Gongzzang 제품 | convention | current | korean | ok | 3 |
| `products/gongzzang/docs/conventions/error-format.md` | Gongzzang 제품 | convention | current | korean | ok | 6 |
| `products/gongzzang/docs/conventions/git-and-pr.md` | Gongzzang 제품 | convention | current | mixed | ok | 4 |
| `products/gongzzang/docs/conventions/naming-and-ids.md` | Gongzzang 제품 | convention | current | mixed | ok | 1 |
| `products/gongzzang/docs/conventions/README.md` | Gongzzang 제품 | README | current | mixed | ok | 5 |
| `products/gongzzang/docs/conventions/rust.md` | Gongzzang 제품 | convention | current | mixed | ok | 4 |
| `products/gongzzang/docs/conventions/sql.md` | Gongzzang 제품 | convention | current | mixed | ok | 1 |
| `products/gongzzang/docs/conventions/testing.md` | Gongzzang 제품 | convention | current | mixed | ok | 3 |
...
| `products/gongzzang/packages/ui/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |

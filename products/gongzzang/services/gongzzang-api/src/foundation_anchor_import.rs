//! Foundation Platform anchor artifact import contract parsing.

use serde::Deserialize;
use thiserror::Error;

pub use gongzzang_persistence::foundation_anchor::AnchorArtifactRow;
...
/// Foundation Platform anchor artifact manifest after contract validation.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct AnchorArtifactManifest {
    /// Immutable artifact version.
    pub artifact_version: String,
    /// Foundation Platform source snapshot id.
    ...
    /// Manifest checksum declared by Foundation Platform.
...
pub struct AnchorArtifactObject {
    /// Shard identity.
    pub shard_id: String,
    /// Foundation Platform source object key.
    pub source_object_key: String,
    /// Foundation Platform anchor object key.
    pub artifact_object_key: String,
    /// Number of JSONL rows in the object.
    pub row_count: u64,
    /// Object byte size declared by Foundation Platform.
    pub size_bytes: u64,
    /// Object checksum declared by Foundation Platform.
    pub checksum_sha256: String,
}
...
pub struct AnchorArtifactRejectObject {
    ...
    /// Foundation Platform source object key.
    pub source_object_key: String,
    /// Foundation Platform rejected object key.
...
/// Foundation Platform anchor artifact import contract error.
#[derive(Debug, Error)]
...
/// Parse a Foundation Platform anchor artifact manifest.
///
/// # Errors
///
/// Returns [`AnchorImportError`] when the manifest JSON or accounting violates
/// the published Foundation Platform artifact contract.
...
/// Parse one Foundation Platform anchor artifact JSONL entry.
///
/// # Errors
///
/// Returns [`AnchorImportError`] when the line is invalid JSON or violates the
/// Foundation Platform anchor artifact contract consumed by Gongzzang.

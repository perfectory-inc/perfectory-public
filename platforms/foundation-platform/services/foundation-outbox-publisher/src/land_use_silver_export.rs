...
mod tests {
    ...
    fn plan_rows_become_contract_shaped_jsonl_and_the_adjacent_row_is_refused_with_a_name() {
        ...
        fs::write(
            &zip_path,
            plan_zip(&[
                "3611034039104450003,3611034039,세종특별자치시 금남면 도암리,1,토지대장,445-3,1380000,3,접함,UEA110,농업진흥구역,2026-06-04,2026-06-06,36110,",
                "36110340391044500,3611034039,세종특별자치시 금남면 도암리,1,토지대장,445-3,1380000,1,포함,UQB300,보전관리지역,2026-06-04,2026-06-06,36110,",
            ]),
        )
        .expect("fixture zip");
        ...
        assert_eq!(row["pnu"], "3611034039104450003");

 ...
 *
 * The generator must fail when `services/gongzzang-api/openapi.json` is absent. Keeping a
...
const OPENAPI_PATH = resolve(__dirname, "../../../services/gongzzang-api/openapi.json");

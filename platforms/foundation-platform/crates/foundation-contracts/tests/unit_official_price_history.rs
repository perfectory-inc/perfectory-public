//! A unit carries its annual official prices through the published contract.
...
#[test]
fn annual_prices_survive_a_contract_round_trip() -> Result<(), serde_json::Error> {
    let mut payload = unit();
    let history = json!([
        {"base_year": 2026, "price_won": 232_000_000},
        {"base_year": 2025, "price_won": 221_000_000}
    ]);

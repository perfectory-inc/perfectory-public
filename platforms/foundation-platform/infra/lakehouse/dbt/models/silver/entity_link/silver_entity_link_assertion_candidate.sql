...
select
    ...
    json_format(cast(map(array['match_path'], array[match_path]) as json)) as evidence,
    cast(null as varchar) as blocking_keys,
    'building-unit-land-right-corroboration.v1' as rule_version,
    cast(null as varchar) as model_name,
    cast(null as varchar) as model_version,
    cast(null as varchar) as model_run_id,
    case
    ...
    'candidate' as publish_state,
    cast(null as varchar) as decision_reason,
    'dbt:int_entity_resolution__building_register_unit_land_right_candidates' as created_by,
    current_timestamp as created_at,
    cast(null as varchar) as reviewed_by,
    cast(null as timestamp) as reviewed_at,
    cast(null as varchar) as published_by,
    ...
    cast(null as varchar) as supersedes_assertion_id,
    lineage_run_id
from {{ ref('int_entity_resolution__building_register_unit_land_right_candidates') }}
...
select
    ...
    json_format(cast(map(array['match_path'], array[match_path]) as json)) as evidence,
    cast(null as varchar) as blocking_keys,
    'court-auction-building-unit-name-match.v1' as rule_version,
    cast(null as varchar) as model_name,
    cast(null as varchar) as model_version,
    cast(null as varchar) as model_run_id,
    case
    ...
    'candidate' as publish_state,
    cast(null as varchar) as decision_reason,
    'dbt:int_entity_resolution__court_auction_building_unit_name_candidates' as created_by,
    current_timestamp as created_at,
    cast(null as varchar) as reviewed_by,
    cast(null as timestamp) as reviewed_at,
    cast(null as varchar) as published_by,
    ...
    cast(null as varchar) as supersedes_assertion_id,
    lineage_run_id
from {{ ref('int_entity_resolution__court_auction_building_unit_name_candidates') }}

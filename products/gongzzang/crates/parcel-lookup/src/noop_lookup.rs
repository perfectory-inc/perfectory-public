...
//!
//! The production API requires `FOUNDATION_PLATFORM_API_BASE_URL` because Foundation
//! Platform owns canonical Catalog parcel data. This fallback exists only for local
...
mod tests {
    ...
    async fn noop_returns_none_for_any_pnu() {
        ...
        let pnu = Pnu::try_new("9999900501107370000").unwrap();

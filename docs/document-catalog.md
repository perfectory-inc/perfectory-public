...
| `platforms/foundation-platform/docs/adr/0025-bronze-catalog-recovery-evidence-sealing.md` | Foundation Platform | ADR | evidence |
...
| `platforms/foundation-platform/docs/architecture/api-exchange-direction-contract.md` | Foundation Platform | architecture | Accepted |
...
| `platforms/foundation-platform/docs/canonical-property-data-platform-northstar.md` | Foundation Platform | documentation | reference / index. 이 문서는 결정이 아니라 **전체 지도이자 색인**이다. |
| `platforms/foundation-platform/docs/catalog/bronze-source-slug-rename.v1.md` | Foundation Platform | reference | current |
| `platforms/foundation-platform/docs/catalog/building-register-consistency-rules.v1.draft.md` | Foundation Platform | reference | review required |
| `platforms/foundation-platform/docs/catalog/building-register-field-mapping.v1.draft.md` | Foundation Platform | reference | review required |
...
| `platforms/foundation-platform/docs/catalog/pipeline-graph.v1.example.json` | Foundation Platform | reference | fixture |
...
| `platforms/foundation-platform/docs/data-quality/lakehouse-quality-rules.v1.example.json` | Foundation Platform | reference | fixture |
| `platforms/foundation-platform/docs/db/catalog-schema-contract.v1.example.json` | Foundation Platform | reference | fixture |
| `platforms/foundation-platform/docs/events/event-fabric-registry.v1.example.json` | Foundation Platform | reference | fixture |
| `platforms/foundation-platform/docs/events/lineage/lakehouse-lineage-event.v1.example.json` | Foundation Platform | reference | fixture |
| `platforms/foundation-platform/docs/events/webhook/outbox-webhook-envelope.v1.example.json` | Foundation Platform | reference | fixture |
| `platforms/foundation-platform/docs/events/webhook/parcel-marker-anchor-snapshot-envelope.v1.example.json` | Foundation Platform | reference | fixture |
| `platforms/foundation-platform/docs/events/webhook/receiver-contract.v1.example.json` | Foundation Platform | reference | fixture |
| `platforms/foundation-platform/docs/observability/slo-policy.v1.example.json` | Foundation Platform | reference | fixture |
...
| `platforms/foundation-platform/docs/runbooks/provider-acquisition-fargate.md` | Foundation Platform | runbook | runtime-neutral reference; Fargate is not selected by this document |
...
| `products/gongzzang/docs/architecture/partner-listing-exchange-boundary.md` | Gongzzang 제품 | architecture | maintained public contract |
...
| `products/gongzzang/docs/conventions/comments.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/enforcement-flow.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/error-format.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/git-and-pr.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/naming-and-ids.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/README.md` | Gongzzang 제품 | README | current |
| `products/gongzzang/docs/conventions/rust.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/sql.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/testing.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/typescript.md` | Gongzzang 제품 | documentation | current |
| `products/gongzzang/docs/conventions/ui-writing-korean.md` | Gongzzang 제품 | documentation | current |

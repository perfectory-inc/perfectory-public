...
import { type FloorsResponse, fetchFloors } from "@/lib/api/floors";
...
import { ParcelFloorsCard } from "./floors";
...
defineKind({
  ...
  views: {
    ...
    floors: defineView<"parcel", FloorsResponse>({
      component: ParcelFloorsCard,
      fetcher: (id, signal) => fetchFloors(id, signal),
      staleTime: 5 * 60_000,
      links: [],
    }),

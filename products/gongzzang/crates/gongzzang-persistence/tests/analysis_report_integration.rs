...
use chrono::Utc;
use gongzzang_persistence::analysis_report::PgAnalysisReportRepository;
...
fn make_report(user_id: Id<UserMarker>, title: &str) -> AnalysisReport {
    AnalysisReport::try_new(
        ...
        title,
        vec![
            Pnu::try_new("9999900101100010000").unwrap(),
            Pnu::try_new("9999900101100020000").unwrap(),
        ],
...
async fn round_trip_with_target_pnus() {
    ...
    assert_eq!(fetched.target_pnus[0].as_str(), "9999900101100010000");

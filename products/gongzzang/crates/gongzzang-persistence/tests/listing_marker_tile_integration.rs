...
const SYNTHETIC_Z11_X: u32 = 1747;
const SYNTHETIC_Z11_Y: u32 = 803;
const SYNTHETIC_Z14_X: u32 = 13977;
const SYNTHETIC_Z14_Y: u32 = 6426;
...
async fn seed_anchor(pool: &sqlx::PgPool, pnu: &str) {
    sqlx::query(
        ...
        values (
            $1,
            ST_SetSRID(ST_MakePoint(127.12347023450, 36.1234565), 4326),
            'polylabel',
            '1',
            'snapshot-test-v1',
            'test-geometry-v1',

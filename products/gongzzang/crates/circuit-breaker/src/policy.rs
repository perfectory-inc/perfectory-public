...
mod tests {
    ...
    #[test]
    fn foundation_platform_default_matches_internal_service_contract() {
        let p = Policy::foundation_platform_default();

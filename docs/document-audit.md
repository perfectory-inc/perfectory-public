...
- 감사 문서: **442개**
- 언어 분류: **{'english': 35, 'korean': 247, 'mixed': 160}**
- 한글화 대상 유지 문서: **영문 전용 0개 / 혼합 표기 84개** (기계 계약·라우터·법률 예외 제외)
- 유지 문서의 명백한 영문 문장: **0개**
- 메타데이터: **211개 정상 / 0개 누락 / 231개 해당 없음**
- 중복 파일명 후보: **0개**
- 링크·참조 위반: **0개**
- 승인 전 문서 유입 링크 0건: **0개**
...
| `docs/adr/0019-membership-is-a-dated-fact-not-a-column.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 22 |
| `docs/adr/0020-geometry-is-not-evidence-for-a-fact.md` | Monorepo | ADR | current | korean | not applicable: ADR fields | 17 |
...
| `docs/adr/0040-a-column-no-producer-fills-cannot-be-required.md` | Monorepo | ADR | Accepted | korean | not applicable: ADR fields | 12 |
...
| `docs/adr/0103-place-identity-outlives-administrative-code-changes.md` | Monorepo | ADR | Accepted | korean | not applicable: ADR fields | 3 |
...
| `docs/reference/knowledge-search-industry-cases.md` | Monorepo | reference | current | korean | ok | 9 |
...
| `platforms/foundation-platform/docs/adr/0004-static-vector-tile-runtime-contract.md` | Foundation Platform | ADR | current | mixed | not applicable: ADR fields | 15 |
...
| `platforms/intelligence-platform/docs/adr/0002-canonical-release-rag-design.md` | Intelligence Platform | ADR | current | mixed | not applicable: ADR fields | 8 |
...
| `products/gongzzang/infrastructure-v2/README.md` | Gongzzang 제품 | README | current | korean | ok | 0 |
